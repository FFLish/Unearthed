...
def run8():
    ...
    try:
        ...
        drb_m(770, 800*speed)
        drb_t(-42, 500)
        drb_m(180, 300*speed)   #Landkarten enthüllen
        print("A:2,1")
        print("A:2,2")
        ...
        drb_m(-115, 150)
        wait(500)
        lmkmove(500, 800*speed) #Pinsel Gefangen
        rmg.run(-100)
        print("A:1")
        lmkmove(350, -600)  
        drb_k(-380, -85, 800)
...
def run9():
    ...
    try:
        ...
        drb_m(100, 1000*speed)
        drb_k(110, 90, 600)
        drb_m(140, 1000*speed) 
        drb_k(110, -75, 600) 
        drb_m(60, 900*speed)    #alles rein
        rmkmove(600,-500)
        wait(500)
        print("A:14")   
        drb_m(-250, 900*speed)
